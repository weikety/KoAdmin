...
namespace Ko.Common.Components.ApiUi
{
  public static class ApiUIOptionsExtensions
  {
      /// <summary>
        ...
        public static void SwaggerEndpoint(this ApiUIOptions options, string url, string name, string version)
        {
            var urls = new List<UrlDescriptor>(options.ConfigObject.Urls ?? Enumerable.Empty<UrlDescriptor>()) {new UrlDescriptor { Url = url, Name = name, Version = version}};
